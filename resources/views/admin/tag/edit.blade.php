                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.user.show', $tag->id) }}">{{ $tag->title }}</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <form action="{{ route('admin.tag.update', $tag->id) }}" method="post" class="w-25">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="title" placeholder="Enter name tag" value="{{ $tag->title }}">
